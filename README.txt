...
A ferramenta de edição usada foi visual studio code, para automação foi utilizado o Selenium bem como comandos disponíveis na página: https://codecept.io/helpers/WebDriver/

3 - Referente aos testes API segue docx (3.Respostas - Testes de API.docx)
